...
flagdata(vis=opms,mode='manual',spw=spwstr)
flagdata(vis=opms,mode='manual',autocorr=True)
flagdata(vis=opms,mode='clip',clipzeros=True)
flagdata(vis=opms,mode='clip',clipminmax=[0.0,50.0])
flagdata(vis=opms,mode='tfcrop')
flagdata(vis=opms,mode='extend',growaround=True,flagneartime=True,flagnearfreq=True,growtime=90.0,growfreq=90.0)
