...
def main():
    ...
    runfile = SCRIPTS+'/run_predict_'+prefix+'.sh'
    slurmfile = SCRIPTS+'/slurm_predict_'+prefix+'.sh'
    logfile = slurmfile.replace('.sh','.log')
    gen.write_runfile_predict(myms,'img_'+prefix+'_databdamask',runfile)
    gen.write_slurm(prefix+'pdct',logfile,WSCLEAN_CONTAINER,runfile,slurmfile)


    job_id_predict = 'PREDICT_'+prefix
    ...
    jobname = prefix+'cbcl'
    runfile = SCRIPTS+'/run_cubical_'+prefix+'.sh'
    slurmfile = SCRIPTS+'/slurm_cubical_'+prefix+'.sh'
    logfile = slurmfile.replace('.sh','.log')
    job_id_cubical = 'CUBICAL_'+prefix
