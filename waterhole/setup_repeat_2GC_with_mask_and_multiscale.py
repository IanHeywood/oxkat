...
def main():
    ...
    for target in targets:
        ...
        mask_prefix = 'img_'+myms+'_msmask_data'
        ...
        slurmfile = SCRIPTS+'/slurm_wsclean_msmask_'+code+'.sh'
        logfile = LOGS+'/slurm_wsclean_msmask_'+code+'.log'
        ...
        job_id_mask = 'MASK1_'+code
        syscall = job_id_mask+"=`sbatch "+slurmfile+" | awk '{print $4}'`"
        f.write(syscall+'\n')
        ...
        syscall = job_id_predict1+"=`sbatch -d afterok:${"+job_id_mask+"} "+slurmfile+" | awk '{print $4}'`"
        f.write(syscall+'\n')
        ...
        slurmfile = SCRIPTS+'/slurm_phasecal2_'+code+'.sh'
        logfile = LOGS+'/slurm_phasecal2_'+code+'.log'
        ...
        job_id_mask2 = 'MASK2_'+code
        syscall = job_id_mask2+"=`sbatch -d afterok:${"+job_id_phasecal2+"} "+slurmfile+" | awk '{print $4}'`"
        f.write(syscall+'\n')
        ...
        syscall = job_id_makemask1+"=`sbatch -d afterok:${"+job_id_mask2+"} "+slurmfile+" | awk '{print $4}'`"        
        f.write(syscall+'\n')
